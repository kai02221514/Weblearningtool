...
2. KAI-32の型付きprofilesと表示名save/loadのlocal実装準備を行う。remote変更を混在させない。
3. KAI-32をlocal実装してmainへ反映した後にKAI-33でKV廃止・remote差分を整理する。KAI-33の停止条件を満たした後だけ、KAI-34で指定remoteへ監査済み変更を適用する。
