    ...
    },
    {
      ...
      researchMetadata: {
        notes: [
          ...
          '`<body>`は明示的な許容解として採用する。`</body>`や`/body`は許容解へ含めない。',
        ...
        acceptedAnswerDecision: {
          ...
          decidedBy: '北代櫂',
          accepted: ['body', '<body>'],
          rejected: ['</body>', '/body', 'head', 'title', 'html', 'p'],
          rationale: [
            '問題文は要素名を要求しているが、開始タグ全体の回答は正答意図が明確な表記揺れとして許容する。',
            '終了タグやスラッシュのみの回答、別要素名は許容解集合にないため不正答とする。',
          ],
        },
        incorrectAnswerExamples: ['</body>', '/body', 'head', 'title', 'html', 'p'],
      },
